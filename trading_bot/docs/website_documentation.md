...
- **Claude Opus 5 everywhere**: chart analysis, trade judge, position/pending re-evals, trade reviews, weekly insights, and sizing all run on Opus 5 with adaptive thinking (medium effort for analysis/judge/reviews with a 32k analysis output budget, low for sizing/re-evals)
