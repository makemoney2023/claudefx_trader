...
An AI-powered forex trading bot combining ICT (Inner Circle Trading), Market Maker, and Fair Value Gap strategies with MetaTrader 5 via MCP, using Claude Opus 5 for intelligent chart analysis and trade execution.
...
- **AI-Powered Analysis**: Claude Opus 5 vision capabilities for chart analysis
...
### Claude Integration
Uses Claude Opus 5 vision API (adaptive thinking, effort=medium) to analyze chart screenshots and generate trade signals.
